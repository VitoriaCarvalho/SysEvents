 ...
 * @author vitoria
 */
public class TelaEditarEventos extends javax.swing.JFrame {

    /**
     * Creates new form TelaEditarEventos
     */
    public TelaEditarEventos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEditarEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEditarEventos().setVisible(true);
            }
        });
    }
